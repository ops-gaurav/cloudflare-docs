...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td colspan="5" rowspan="1">
        The percentage of overall requests served by R2 over a period of time. <br />
    ...
    <tr>
      ...
      <td colspan="5" rowspan="1">
        The amount of data that has been copied from the source bucket to R2 over a period of time. Reported in bytes.
      </td>
    </tr>
  </tbody>
</table>
